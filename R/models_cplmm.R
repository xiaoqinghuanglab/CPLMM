#' Fit change-point LMMs across multiple proteins and strata
#'
...
#' Beta 1 is `-coef(before_onset)` (slope wrt years_before_onset),
#' and Beta 3 is `coef(after_onset)`.
#'
...
fit_cplmm_all_proteins <- function(
    df_status_change,
    df_normal,
    df_abnormal,
    protein_list,
